...
public class FragmentInformacion extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ImageButton btnWeb = (ImageButton)rootView.findViewById(R.id.btnWeb);
        ...
        //SupportMapFragment mapa = (SupportMapFragment)
        ...
        txtNumValoraciones.setText("/"+festival.getNumValoraciones());
        txtNumSeguidores.setText(numSeguidores);
