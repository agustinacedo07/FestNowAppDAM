 ...
 * Realiza las comprobaciones haciendo uso de un objeto propio llamado Validator, que contiene un procesamiento y análisis tanto
 * general como particular de los campos analizados
 */
public class ControlErroresRegistro implements CallBackControlErroresBD {
    ...
    private ArrayList<Validator> listaValidator;
    ...
    /**
     * Control de mail, tanto en formato, como en la base de datos (si ya existe o no)
     * @param email - la cadena a analizar
     * @return - el objeto validator con el procesamiento de su control de errores
     */
    public Validator  controlEmail(String email){
        ...
        //validacion de campo mail en la BD
    ...
    /**
     * Control del campo fecha, comprueba que no sea superior a la actual y que sea máximo de 18 años hacia atras
     * @param fecha
     * @return - el objeto validator con el procesamiento de su control de errores
     */
    ...
    /**
     * Control de usuario, para comprobar si existe o no en la base de datos
     * @param usuario
     * @return -el objeto validator con el procesamiento de su control de errores
     */
    ...
    /**
     * Control de que no exista ya una contraseña igual en la BD
     * @param pass
     * @return - el objeto validator con el procesamiento de su control de errores
     */
